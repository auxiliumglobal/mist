...
Template['popupWindows_sendTransactionConfirmation'].helpers({
    ...
    */
    'totalAmount': function () {
        var amount = EthTools.formatBalance(this.value, '0,0.00[0000000000000000]', 'SPP');
    ...
    */
    'estimatedFee': function () {
        ...
        if (gas && this.gasPrice) {
            return EthTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000] unit', 'SPP');
        }
    },
    /**
    ...
    */
    'providedGas': function () {
        ...
        if (gas && this.gasPrice) {
            return EthTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000]', 'SPP');
        }
    },
    /**
