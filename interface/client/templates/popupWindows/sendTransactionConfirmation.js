    ...
    */
    'estimatedFee': function () {
        ...
        if (gas && this.gasPrice) {
            var formatted = EthTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000] unit', 'ether');
            return formatted.substring(0, formatted.lastIndexOf(' ')) + ' ' + 'AUX';
        }
    },
    /**
